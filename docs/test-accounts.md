...
- **Database** — the user-service seed changelogs under
  ...
  `0001`, additional active accounts in `0003`, and the clean onboarding account in `0004`.
...
| Username | Email | Password | Enabled | Roles | Characteristics | Seeded posts | Intended use |
|---|---|---|---|---|---|---:|---|
| john.doe | john.doe@example.com | password123 | yes | user, admin | filled | 10 | Admin and established-user flows |
| jane.smith | jane.smith@example.com | password123 | yes | user | filled | 10 | Established-user flows |
| bob.johnson | bob.johnson@example.com | password123 | **no** | user | filled | 0 | Inactive-user path; cannot log in |
| alice.williams | alice.williams@example.com | password123 | yes | user | filled | 10 | Established-user/feed flows |
| maya.patel | maya.patel@example.com | password123 | yes | user | filled | 10 | Established-user/feed flows |
| theo.campbell | theo.campbell@example.com | password123 | yes | user | filled | 10 | Established-user/feed flows |
