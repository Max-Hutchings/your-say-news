...
function completeForm(): OnboardingForm {
    return {
        ...
        currency: "GBP",
        incomeCatalogVersion: "2026.1",
        incomeProfileId: "GB-GBP-GROSS-2025-v1",
        incomeProfileVersion: 1,
        incomeMarketCode: "GB",
        personalIncomeBandId: "PERSONAL_TIER_4",
        householdIncomeBandId: "HOUSEHOLD_TIER_5",
...
describe("isRequiredComplete", () => {
    ...
    it.each([
        ...
        ["income catalogue version", { incomeCatalogVersion: null }],
        ["income profile", { incomeProfileId: null }],
        ["income profile version", { incomeProfileVersion: null }],
        ["invalid income profile version", { incomeProfileVersion: 0 }],
        ["income market", { incomeMarketCode: null }],
        ["income currency", { currency: "" }],
        ["cross-market income profile", { incomeMarketCode: "IN" }],
        ["personal income band", { personalIncomeBandId: null }],
        ["household income band", { householdIncomeBandId: null }],
...
describe("createEmptyOnboardingForm", () => {
    it("returns the complete stable draft shape", () => {
        expect(createEmptyOnboardingForm()).toEqual({
            country: "", countryCode: null, city: "", region: "", ukCounty: null, urbanRural: null,
            ...
            currency: "USD", incomeCatalogVersion: null, incomeProfileId: null,
            incomeProfileVersion: null, incomeMarketCode: null, personalIncomeBandId: null,
            householdIncomeBandId: null, height: null,
    ...
    it("maps the form onto the answer payload with backend enum values", () => {
        ...
        expect(answers).toEqual({
            ...
            income: {
                ...
                marketCode: "GB",
                currencyCode: "GBP",
                personalBandId: "PERSONAL_TIER_4",
